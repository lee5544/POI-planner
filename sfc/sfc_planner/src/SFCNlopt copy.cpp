...
void SFCNlopt::setPOIs(POIContainer interest_obs)
{
    ...
    std::cout << "initial refineSFCEnv: " << interest_obs_.size() << "   " << std::chrono::duration_cast<std::chrono::microseconds>(t2 - t1).count() / 1000.0 << " ms" << std::endl;
}
...
void SFCNlopt::optimize(bool change)
{
    ...
    t2 = std::chrono::system_clock::now();
    // std::cout << "refineSFCEnv: " << std::chrono::duration_cast<std::chrono::microseconds>(t2 - t1).count() / 1000.0 << " ms" << std::endl;
    ...
    do
    {
        do
        {
            try
            {
                ...
                if (verbose_)
                {
                    ...
                    //     std::cout << "[SFCNlopt ========== feasloop " << feasloop_ << " ============ SFCNlopt]" << std::endl;
                    //     std::cout << "[SFCNlopt optimization variables] " << dim_ << " " << traj_pts_num_ << " " << variable_num_ << std::endl;
                    //     std::cout << "[SFCNlopt result]: " << result << std::endl;
                    ...
                    //     std::cout << "[SFCNlopt interest obstacle number]:  " << interest_obs_.size() << std::endl;
                }
            }
        ...
        if (feasloop_ > 10)
        {
            std::cout << "[SFCNlopt ========== feasloop over 10, break ============ SFCNlopt]" << std::endl;
            break;
        }
    ...
    // {
    //     std::cout << "[SFCNlopt ========== feasloop " << feasloop_ << " ============ SFCNlopt]" << std::endl;
    //     std::cout << "[SFCNlopt ========== outloop " << outloop_ << " ============ SFCNlopt]" << std::endl;
    //     std::cout << "[SFCNlopt optimization variables] " << dim_ << " " << traj_pts_num_ << " " << variable_num_ << std::endl;
    //     // std::cout << "[SFCNlopt result]: " << result << std::endl;
    //     std::cout << "[SFCNlopt optimal value, f_smoothness, f_distance, f_feasibility ]: " << optimal_value_ << ",    " << f_smoothness_ << ",    " << f_distance_ << ",    " << f_feasibility_ << std::endl;
    //     std::cout << "[SFCNlopt iteration count]: " << inloop_ << std::endl;
